...
//categories: c and c++
...
else if (input == "difference between c and c++") {
    return "C++ was developed as an extension of C, and both languages have almost the same syntax.The main difference between C and C++ is that C++ support classes and objects, while C does not.";
} 
    ...
    return "Some features of the C language are- - -It is Simple And Efficient.- C language is portable or Machine Independent.-C is a mid-level Programming Language. -It is a structured Programming Language. -It has a function-rich library. - Dynamic Memory Management. -C is super fast. -We can use pointers in C. -It is extensible";
} 
else if (input == "features of c ") {
    return "Some features of the C language are- - -It is Simple And Efficient.- C language is portable or Machine Independent.-C is a mid-level Programming Language. -It is a structured Programming Language. -It has a function-rich library. - Dynamic Memory Management. -C is super fast. -We can use pointers in C. -It is extensible";
} 
else if (input == "features of c programming language") {
    return "Some features of the C language are- - -It is Simple And Efficient.- C language is portable or Machine Independent.-C is a mid-level Programming Language. -It is a structured Programming Language. -It has a function-rich library. - Dynamic Memory Management. -C is super fast. -We can use pointers in C. -It is extensible";
} 
...
//AWT
    ...
    return "Extensible Markup Language is a markup language and file format for storing, transmitting, and reconstructing arbitrary data. It defines a set of rules for encoding documents in a format that is both human-readable and machine-readable.";
} 
else if (input == "xml") {
    return "Extensible Markup Language is a markup language and file format for storing, transmitting, and reconstructing arbitrary data. It defines a set of rules for encoding documents in a format that is both human-readable and machine-readable.";
} 
...
else if (input == "what is c# dotnet") {
    return "The C#.NET is one of the Microsoft programming languages. It is the most powerful programming language among all programming languages available in the .NET Framework. The C#.NET contains all the features of C++, VB.NET, JAVA, and also some additional features. .It is designed and developed by Microsoft and the first beta version released in 2000. The C#.Net programming language is designed to be a simple, modern, general-purpose, and completely object-oriented programming language.";
} 
else if (input == "define c# dotnet") {
    return "The C#.NET is one of the Microsoft programming languages. It is the most powerful programming language among all programming languages available in the .NET Framework. The C#.NET contains all the features of C++, VB.NET, JAVA, and also some additional features. .It is designed and developed by Microsoft and the first beta version released in 2000. The C#.Net programming language is designed to be a simple, modern, general-purpose, and completely object-oriented programming language.";
} 
else if (input == "c# dotnet") {
    return "The C#.NET is one of the Microsoft programming languages. It is the most powerful programming language among all programming languages available in the .NET Framework. The C#.NET contains all the features of C++, VB.NET, JAVA, and also some additional features. .It is designed and developed by Microsoft and the first beta version released in 2000. The C#.Net programming language is designed to be a simple, modern, general-purpose, and completely object-oriented programming language.";
} 

//dicrete math
else if (input == "what is discrete math") {
...
else if (input == "define discrete math") {
    return "Discrete mathematics is the branch of mathematics dealing with objects that can consider only distinct, separated values. This tutorial includes the fundamental concepts of Sets, Relations and Functions, Mathematical Logic, Group theory, Counting Theory, Probability, Mathematical Induction, and Recurrence Relations, Graph Theory, Trees and Boolean Algebra";
} 
...
//DCCN
else if (input == "what is computer networks") {
...
//datascience
else if (input == "what is data science") {
